...
- In V0 to V9 we have mentioned the data of sensors and gave input to it (Vibrations along x,y,z axis, temperature, speed, motor status etc.)
- We connected pull up register between the VCC and D4 terminal ( for tempareture sensor)
- Connected the D4 terminal with tempareture sensor and current sensor with 5V power supply 
