- we set up the motor along with the relevent sensors
- The capacitor and the diodes are connected in parallel across the terminals of the motor in the veroboard
- the motor is fixed with the board with a china clip 
